...
public class Ingress extends Entity {
	...
	public Ingress(String name) {
		...
		case "windowright":											//to create a new kind of ingress, add to the switch case constructor.
			...
			setUpIngressSprites(new Vector2(735, 40), filenamesLarry, "rightwindowNOlarry1.png");
		...
		case "windowleft":
			...
			setUpIngressSprites(new Vector2(175, 36), filenamesLarry, "leftwindow.png");
		...
		case "doorright":
			...
			setUpIngressSprites(new Vector2(1175, 45), filenamesLarry, "rightdoorspriteNOlarry.png");
